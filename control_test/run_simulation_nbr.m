function [TrackingError_vector, t_set] = run_simulation_nbr(CurrentMode, SaveFolderName, SaveFileName, use_formation)
...
fprintf('Mode: NBR-%s  Formation: %d  done, total=%.2fs\n', CurrentMode, use_formation, toc);
